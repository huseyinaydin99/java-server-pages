...
<fmt:bundle basename="tr.com.huseyinaydin.BundleSinifiTR">
...
<fmt:bundle basename="tr.com.huseyinaydin.BundleSinifiTR" prefix="onAd.">
...
<fmt:setBundle basename="tr.com.huseyinaydin.BundleSinifiTR" var="dilSinifi"  />
...
<fmt:setBundle basename="tr.com.huseyinaydin.BundleSinifiEN" var="dilSinifi"  />
<fmt:message key="onAd.mesajkisim1" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim2" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim3" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim4" bundle="${dilSinifi}"/>
...
<fmt:setBundle basename="tr.com.huseyinaydin.BundleSinifiRU" var="dilSinifi"  />
<fmt:message key="onAd.mesajkisim1" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim2" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim3" bundle="${dilSinifi}"/> -
<fmt:message key="onAd.mesajkisim4" bundle="${dilSinifi}"/>
