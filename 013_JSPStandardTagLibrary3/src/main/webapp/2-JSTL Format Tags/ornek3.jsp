...
<body>
	...
	<fmt:parseNumber var="parseNumberSayimiz" type="number"
		value="${sayimiz}" integerOnly="true" />
	Sayımız :
	<font color="blue"><c:out value="${sayimiz}" /></font>
	<br> fmt:parseNumber ile işlenen Sayımız :
	...
	<fmt:parseDate value="${tarih}" var="parsedDateEdilmisTarih"
		pattern="dd-MM-yyyy" />
	Tarihimiz :
	<font color="blue"><c:out value="${tarih}" /></font>
	<br> fmt:parseDate ile işlenen Tarihimiz :
	...
	<font color="blue"> <fmt:formatDate value="${zaman}" type="both"
			timeStyle="long" dateStyle="long" />
	</font>
	<br> fmt:setTimeZone ile Saat dilimimizi değiştirerek yapalım :
	<fmt:setTimeZone value="GMT-16" />
	<font color="green">GMT-16</font>
	<br> Değişen Tarih ve Saat :
	<font color="red"><fmt:formatDate value="${zaman}" type="both"
			timeStyle="long" dateStyle="long" /></font>
