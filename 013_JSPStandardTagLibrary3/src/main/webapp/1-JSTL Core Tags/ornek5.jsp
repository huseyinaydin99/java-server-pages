...
<body>
	...
	<c:forEach var="for_each_icin_parcalarina_ayir"
		items="${param.for_each_icin_parametre_adi}">
		<c:out value="${for_each_icin_parcalarina_ayir}" />
		<br>
	</c:forEach>
	<hr>
	<h3>JSTL c:forTokens kullanımı</h3>
	<c:forTokens var="for_token_icin_parcalarina_ayir"
		items="${param.for_token_icin_parametre_adi}" delims=";">
