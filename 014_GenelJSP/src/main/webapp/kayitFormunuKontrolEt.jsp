...
<body>
	...
	<jsp:useBean id="fasulye" class="tr.com.huseyinaydin.kayitpaketi.GirilenDegerleriKontrolEdenSinif" />

	<jsp:setProperty name="fasulye" property="kullaniciadimiz" />
	<jsp:setProperty name="fasulye" property="parolamiz" />

	<%
		tr.com.huseyinaydin.kayitpaketi.GirilenDegerleriKontrolEdenSinif denetlemeNesnesi = (tr.com.huseyinaydin.kayitpaketi.GirilenDegerleriKontrolEdenSinif) pageContext.getAttribute("fasulye");
	...
	<table border="1" width="20%">
		<tr>
			<td width="30%">Adı</td>
			<td width="70%">
				<strong><%=denetlemeNesnesi.getkullaniciadimiz()%></strong>
			</td>
		</tr>
		<tr>
			<td>Parola</td>
			<td>
				<strong><%=denetlemeNesnesi.getparolamiz()%></strong>
			</td>
		</tr>
	</table>
