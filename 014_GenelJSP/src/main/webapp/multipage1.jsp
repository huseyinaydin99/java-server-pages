	...
	<form name="registerationForm" method="POST" action="multipage2.jsp">
		<table border="1" width="70%" cellspacing="1" cellpadding="0" id="table1">
			...
			<tr>
				...
				<td>
					<input type="text" name="loginName" size="20" value="<%=register.getLoginName() != null ? register.getLoginName() : ""%>">
				</td>
			</tr>
			<tr>
				<td width="50%">Last Name</td>
				<td>
					<input type="text" name="password" size="20" value="<%=register.getPassword() != null ? register.getPassword() : ""%>">
				</td>
			</tr>
			<tr>
				<td width="50%">Introduce Yourself</td>
				<td>
					<textarea name="intro" cols="40" rows="10"><%=register.getIntro() != null ? register.getIntro() : ""%></textarea>
				</td>
			</tr>
			<tr>
