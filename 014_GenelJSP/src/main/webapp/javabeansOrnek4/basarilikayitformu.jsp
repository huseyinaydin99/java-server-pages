<jsp:useBean id="kahveFasulyesi" class="tr.com.huseyinaydin.isbasvurusupaketi.ElemanSinifi"
	scope="request" />
...
<body>
	<table cellpadding=1 cellspacing=1 border="7">
		...
		<tr bgcolor="CCFF66">
			<td valign=top>
                <b>
                    <font size=3 color="darkblue">Adı</font>
                </b>
                <br>
			...
			<td valign=top>
                <b>
                <font size=3 color="darkblue">Soyadı</font>
                </b>
				<br>
		...
		<tr bgcolor="CCFF66">
			<td valign=top>
                <b>
                <font size=3 color="darkblue">E-Mail</font>
                </b>
				<br>
			...
			<td valign=top>
                <b>
                <font size=3 color="darkblue">Posta Kodu</font>
                </b>
                <br>
		...
		<tr bgcolor="CCFF66">
			<td valign=top>
                <b><font size=3 color="darkblue">Kullanıcı Adı</font>
                </b>
                <br>
			...
			<td valign=top>
                <b>
                <font size=3 color="darkblue">Cinsiyetiniz</font>
                </b>
				<br>
		...
		<tr bgcolor="CCFF66">
			<td valign=top colspan=2>
                <b>
                <font size=3 color="darkblue">Adres</font>
                </b>
                <br><jsp:getProperty name="kahveFasulyesi" property="adres" />
			</td>
		</tr>
		...
		<tr bgcolor="CCFF66">
			...
			<b>
				<font size=3 color="darkblue">Tecrübeli olduğunuz alanlar</font>
			</b>
			<br>
			<%
