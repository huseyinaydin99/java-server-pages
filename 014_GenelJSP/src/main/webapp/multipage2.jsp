		...
		<table border="1" width="70%" cellspacing="1" cellpadding="0" id="table1">
			<%
				...
				if (errors != null && errors.trim().length() > 0) {
					out.println("<tr><td colspan='2'>Hatalar: <br>" + errors + "</td></tr>");
				}
			%>
			<tr>
				<td width="50%">Phone</td>
				<td>
					<input type="text" name="phone" size="20" value="<%=register.getPhone() != null ? register.getPhone() : ""%>">
				</td>
			</tr>
			<tr>
				<td width="50%">Address</td>
				<td>
					<input type="text" name="address" size="20" value="<%=register.getAddress() != null ? register.getAddress() : ""%>">
				</td>
			</tr>
			<tr>
				<td width="50%">City</td>
				<td>
					<input type="text" name="city" size="20" value="<%=register.getCity() != null ? register.getCity() : ""%>">
				</td>
			</tr>
			<tr>
				<td width="50%">State</td>
				<td>
					<input type="text" name="state" size="20" value="<%=register.getState() != null ? register.getState() : ""%>">
				</td>
			</tr>
			<tr>
