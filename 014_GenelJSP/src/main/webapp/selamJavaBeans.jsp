...
<%@ page import="tr.com.huseyinaydin.selamJavaBeansPaketi.SelamlamaSinifi"%>
<%@ page info="Selam JavaBeans"%>

<jsp:useBean id="bizimFasulyemiz" scope="page" class="tr.com.huseyinaydin.selamJavaBeansPaketi.SelamlamaSinifi" />
...
<body bgcolor="#ffffff" background="resimler/zemin.gif">
	...
	<table border="1" width="700">
		...
		<tr>
			<td width="10">&nbsp;</td>
			<td width="550">
				<form name="selamJavabeansFormu" method="get"
					action="selamJavaBeans.jsp">
