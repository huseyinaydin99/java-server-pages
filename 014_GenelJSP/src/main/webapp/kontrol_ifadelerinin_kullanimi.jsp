    ...
    <body>
         ...
         %>
          ...
          <%
            ...
            {
               out.print("İSTANBUL'UN FETİH TARİHİ " + sayi + " DEĞİLDİR.<br />" + sayi + " OSMANLI İMPARATORLUĞUNUN KURULUŞ TARİHİDİR");
            }
          %>       
          ...
          int a = -5 ;
          do {
            out.println ("ŞART SAĞLANMASA BİLE do- while döngüsü<br />" + "EN AZ 1 KERE ÇALIŞTIRILIR. ");
              a--;
            }  while ( a > 0 );
          %>         
